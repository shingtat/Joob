...
<%
	...
	if(userType.equals("Student")) {
		...
		employerList = (Vector<Employer>)session.getAttribute("matchedList");

	}
	else {
		employer = sqldriver.getEmployer(username);
		studentList = (Vector<Student>)session.getAttribute("matchedList");
	}
%>
...
<body>
    ...
    <li><a href="${pageContext.request.contextPath}/jsp<%=StringConstants.searchPage%>">Search</a></li>
    <li><a href="${pageContext.request.contextPath}/jsp<%=StringConstants.explorePage%>">Explore</a></li>
    <li><a href="${pageContext.request.contextPath}/jsp<%=StringConstants.chatPage%>">Chat</a></li>
    </ul>
    <ul class="nav navbar-nav navbar-right">
      <li><a href="jsp/<%=StringConstants.loginPage%>"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
    </ul>
    </div>
